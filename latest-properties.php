<?php
    ...
    if (isset($_GET['filter-search']) && $_GET['filter-search'] == 'full-search') {
        $rent_sql  = "SELECT * FROM property WHERE status='RT' AND ";
        ...
        $sale_sql  = "SELECT * FROM property WHERE status='SA' AND ";
        ...
        $rent_total_pages = $conn->query("SELECT * FROM property WHERE status='RT'")->num_rows;
        $sale_total_pages = $conn->query("SELECT * FROM property WHERE status='SA'")->num_rows;
    }
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="container pt-5 mb-5">
            ...
            <nav style="float: right;padding: 10px;">
                ...
                <?php if(!empty($total_pages)):for($i=1; $i<=$total_pages; $i++):  
                    if($i == 1):?>
                    <li class='active' id="<?php echo $i;?>"><a href='rent-pagination.php?page=<?php echo $i;?>'><?php echo $i;?></a></li> 
                    <?php else:?>
                    <li id="<?php echo $i;?>"><a href='rent-pagination.php?page=<?php echo $i;?>'><?php echo $i;?></a></li>
                <?php endif;?>          
                <?php endfor; endif;?>
                </ul>
            </nav>
        ...
        <div class="container pt-5 mb-5">
            ...
            <div class="row mt-5">
                ...
                <nav style="float: right;padding: 10px;">
                    ...
                    <?php if(!empty($total_pages)):for($i=1; $i<=$total_pages; $i++):  
                        if($i == 1):?>
                        <li class='active' id="<?php echo $i;?>"><a href='sale-pagination.php?page=<?php echo $i;?>'><?php echo $i;?></a></li> 
                        <?php else:?>
                        <li id="<?php echo $i;?>"><a href='sale-pagination.php?page=<?php echo $i;?>'><?php echo $i;?></a></li>
                    <?php endif;?>          
                    <?php endfor; endif;?>
                    </ul>
                </nav>
    ...
    $(document).ready(function(){
        ...
        $('.rent-pagination').pagination({
            ...
            onPageClick : function(pageNumber) {
                ...
                if (filter_search == 'full-search') {
                    jQuery("#rent-target-content").load("rent-pagination.php?page="+pageNumber+"&location="+location+"&property_type="+propertyType+"&min="+min+"&max="+max+"&beds="+beds+"&baths="+baths+"&filter-search="+filter_search);
                } else {
                    jQuery("#rent-target-content").load("rent-pagination.php?page=" + pageNumber);
                }
            },
            onInit :function() {
                jQuery("#rent-target-content").html('<img src="assets/images/loader.gif" width="300" height="150" />');
                if (filter_search == 'full-search') {
                    jQuery("#rent-target-content").load("rent-pagination.php?page=1"+"&location="+location+"&property_type="+propertyType+"&min="+min+"&max="+max+"&beds="+beds+"&baths="+baths+"&filter-search="+filter_search);
                } else {
                    jQuery("#rent-target-content").load("rent-pagination.php?page=1");
                }
            }
        });
        ...
        $('.sale-pagination').pagination({
            ...
            onPageClick : function(pageNumber) {
                ...
                if (filter_search == 'full-search') {
                    jQuery("#sale-target-content").load("sale-pagination.php?page="+pageNumber+"&location="+location+"&property_type="+propertyType+"&min="+min+"&max="+max+"&beds="+beds+"&baths="+baths+"&filter-search="+filter_search);
                } else {
                    jQuery("#sale-target-content").load("sale-pagination.php?page=" + pageNumber);
                }
            },
            onInit :function() {
                jQuery("#sale-target-content").html('<img src="assets/images/loader.gif" width="300" height="150" />');
                if (filter_search == 'full-search') {
                    jQuery("#sale-target-content").load("sale-pagination.php?page=1"+"&location="+location+"&property_type="+propertyType+"&min="+min+"&max="+max+"&beds="+beds+"&baths="+baths+"&filter-search="+filter_search);
                } else {
                    jQuery("#sale-target-content").load("sale-pagination.php?page=1");
                }
            }
        });
    });
